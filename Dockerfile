...
# We add torch and torchvision to the install to ensure all dependencies, including numpy, are resolved together.
RUN pip install --no-cache-dir -q torch==2.2.1 torchvision==0.17.1 \
